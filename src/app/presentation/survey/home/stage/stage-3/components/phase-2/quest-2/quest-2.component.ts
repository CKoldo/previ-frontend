...
export class Quest2Component {
  ...
  getDataSave(): any {
    return {
      ...
      pregunta6: this.quest3,
      pregunta7: this.cantidadTutoria,
    };
  }
  ...
  ngOnInit() {
    if(this.dataEntry){
      ...
      this.quest3 = this.dataEntry.pregunta6 || null;
      this.cantidadTutoria = this.dataEntry.pregunta7 || 0;
  ...
  onQuest2Change(event: any) {
   ...
   onQuest3Change(event: any) {
    this.quest3 = event;
    this.cantidadTutoria = 0;
  }
  ...
  validateDataSave() {
    ...
    if (this.quest3 == null || this.quest3 == undefined || this.quest3 == '') {
      return false;
    }
    if (this.quest3 == 'true') {
      if (this.cantidadTutoria.toString().trim() == '') {
        return false;
      }
    }
