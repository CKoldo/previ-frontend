...
@Component({
  selector: 'app-stage-2026-phase-1-quest-1',
  imports: [FormsModule, CommonModule,DropdownModule,InputNumberModule, InputTextModule],
  templateUrl: './quest-1.component.html',
  styleUrls: ['./quest-1.component.css']
})
