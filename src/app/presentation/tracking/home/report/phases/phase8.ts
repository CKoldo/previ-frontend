...
/*
export function handlePhase8Tarea1(item: Item): any[] {
  return [[...baseCols(item), 'Tarea 1 (sin datos)']];
}

export function handlePhase8Tarea2(item: Item): any[] {
   return [[...baseCols(item), 'Tarea 2 (sin datos)']];
}
export function handlePhase8Tarea3(item: Item): any[] {
  return [[...baseCols(item), 'Tarea 3 (sin datos)']];
}

export function handlePhase8Tarea4(item: Item): any[] {
  return [[...baseCols(item), 'Tarea 4 (sin datos)']];
}

export function handlePhase8Tarea5(item: Item): any[] {
